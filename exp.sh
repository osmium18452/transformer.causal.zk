torchrun --nproc_per_node=8 --nnodes=1  main.py -MGN std -e 10 -b 1024 -i 48 -p 24
torchrun --nproc_per_node=8 --nnodes=1  main.py -MGN std -e 10 -b 512 -i 48 -p 48
torchrun --nproc_per_node=8 --nnodes=1  main.py -MGN std -e 10 -b 256 -i 48 -p 96
torchrun --nproc_per_node=8 --nnodes=1  main.py -MGN std -e 10 -b 128 -i 48 -p 168
torchrun --nproc_per_node=8 --nnodes=1  main.py -MGN std -e 10 -b 64 -i 48 -p 200
torchrun --nproc_per_node=8 --nnodes=1  main.py -MGN std -e 10 -b 32 -i 48 -p 336
